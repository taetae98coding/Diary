...
internal class HolidayDataStorePreferences(
	...
	private fun dirtyKey(year: Int, month: Month): Preferences.Key<Boolean> = booleanPreferencesKey("$year${month.number.toString().padStart(2, '0')}")
