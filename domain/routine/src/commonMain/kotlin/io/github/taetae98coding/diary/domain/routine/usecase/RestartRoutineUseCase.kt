...
@Factory
public class RestartRoutineUseCase(
    private val requestSyncUseCase: RequestSyncUseCase,
    @param:Provided
    private val accountRoutineRepository: AccountRoutineRepository,
) {
    public suspend operator fun invoke(routineId: Uuid): Result<Unit> {
        return runCatching {
            accountRoutineRepository.updateFinish(routineId = routineId, isFinished = false)
