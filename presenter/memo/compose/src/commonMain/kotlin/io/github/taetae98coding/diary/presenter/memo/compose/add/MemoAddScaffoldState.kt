...
public class MemoAddScaffoldState(
...
@Composable
public fun rememberMemoAddScaffoldState(): MemoAddScaffoldState {
    return rememberMemoAddScaffoldState(initialLocalDateRange = null)
}

@Composable
public fun rememberMemoAddScaffoldState(initialLocalDateRange: LocalDateRange?): MemoAddScaffoldState {
